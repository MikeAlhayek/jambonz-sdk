...
public static class TestToSpeechWebhookEndpoint
{
    public static IEndpointRouteBuilder AddTextToSpeechWebhookEndpoint(this IEndpointRouteBuilder builder)
    {
        builder.MapPost("jambonez/webhook/tts", HandleAsync)
            .AllowAnonymous()
            .DisableAntiforgery();
    ...
    private static async Task<IResult> HandleAsync(
        ...
        [FromKeyedServices("tts")] IJambonzSessionManager sessionManager,
