...
public static class LargeLanguageModelWebhookEndpoint
{
    public static IEndpointRouteBuilder AddLargeLanguageModelWebhookEndpoint(this IEndpointRouteBuilder builder)
    {
        builder.MapPost("jambonez/webhook/llm", HandleAsync)
            .AllowAnonymous()
            .DisableAntiforgery();
    ...
    private static async Task<IResult> HandleAsync(
        ...
        [FromKeyedServices("llm")] IJambonzSessionManager sessionManager,
